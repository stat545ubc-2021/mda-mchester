...
In the ```cancer_sample```, each row is an observation. Each column is a unique variable of the tumour, and each cell is a value in the form of numbers (quantitative) or strings (qualitative). In its current format, the data meets the criteria of tidy data. 
...
For the purpose of completing Milestone 3, questions 1 and 2 will be selected for further analysis. For question 1, additional variables can be added to create predictive models. For question 2, an analysis of the significance of the difference in means can be postulated. Both of these activities are of greatest interest to the author. 
