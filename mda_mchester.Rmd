...
2. Is symmetry_mean a significant predictor of a benign diagnosis?\n

3. Is the relationship between symmetry_mean and smoothness_mean statistically significant?\n

4. What is the strength of association between mean radius and area in benign diagnoses?\n
...
To understand the relationship of area_mean and malignant diagnoses, the range, mean, median, and standard deviation across both outcomes will be computed.
...
ggplot(cancer_sample, #visualize relationship between area and diagnosis
  ...
  labs(x = "Diagnosis", #add labels
       y = "Area (Mean)", 
       caption = "Source: UCI, 1995")
summary(aov(area_mean ~ diagnosis, data = cancer_sample)) #run ANOVA for significance
