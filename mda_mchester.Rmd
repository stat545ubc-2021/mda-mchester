...
The purpose of this markdown is to complete STAT 545A Mini-Data Analysis (Milestone 1). The author will:
- Become familiar with one dataset
- Create four questions from dataset
- Write reproducible and clear report with R Markdown
