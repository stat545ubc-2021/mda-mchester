...
In this next example, the data will be untidied with the addition of
categorical and continuous variables in the `radius_mean` column.
...
```
    ...
    ##  1 M         27                   123.      1001           0.118          0.242
    ##  2 M         56                   133.      1326           0.0847         0.181
    ##  3 M         male                 130       1203           0.110          0.207
    ##  4 M         42                    77.6      386.          0.142          0.260
    ##  5 M         52                   135.      1297           0.100          0.181
    ##  6 M         85                    82.6      477.          0.128          0.209
    ##  7 M         28                   120.      1040           0.0946         0.179
    ##  8 M         61                    90.2      578.          0.119          0.220
    ##  9 M         47                    87.5      520.          0.127          0.235
    ## 10 M         34                    84.0      476.          0.119          0.203
    ## # … with 559 more rows, and 1 more variable: category_symmetry <fct>
